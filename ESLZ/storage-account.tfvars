storageaccounts = {
  example01 = {                           # Key defines the userDefinedString
    ...
    # enable_https_traffic_only        = true        # Optional: Possible values: true, false. Default: true. Can uncomment to set this value
    # min_tls_version                  = "TLS1_2"    # Optional: Possible values: TLS1_0, TLS1_1, TLS1_2. Default: TLS1_2. Can uncomment to set this value
    # shared_access_key_enabled        = true        # Optional: Possible values: true, false. Default: true. Can uncomment to set this value
